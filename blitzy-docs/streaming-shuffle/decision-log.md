...
| F-105 Block resolver: 3-level index, `MigratableResolver` by delegation to `IndexShuffleBlockResolver` | `core/src/main/scala/org/apache/spark/shuffle/streaming/StreamingShuffleBlockResolver.scala` | `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleManagerSuite.scala` (resolver exposure), `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleWriterSuite.scala` (publication), `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleIntegrationSuite.scala` and `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleIntegrationTest.scala` (active publish&rarr;fetch round-trip) | &mdash; |
...
| Config `spark.shuffle.streaming.maxBandwidthMBps` (Int, default `0` = unlimited) | `core/src/main/scala/org/apache/spark/internal/config/package.scala` (`ConfigEntry`), `core/src/main/scala/org/apache/spark/shuffle/streaming/StreamingShuffleConfig.scala` (`maxBandwidthMBps`, `effectiveBandwidthBytesPerSec`) | `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleHandleSuite.scala`, `core/src/test/scala/org/apache/spark/shuffle/streaming/BackpressureProtocolSuite.scala` | &mdash; |
