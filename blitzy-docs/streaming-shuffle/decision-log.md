...
| Write-path / read-path microbenchmark (sort vs streaming) via `BenchmarkBase`; regenerates `core/benchmarks/StreamingShuffleBenchmark-results.txt` via `SPARK_GENERATE_BENCHMARK_FILES=1` | `core/src/main/scala/org/apache/spark/shuffle/streaming/StreamingShuffleWriter.scala`, `core/src/main/scala/org/apache/spark/shuffle/streaming/StreamingShuffleReader.scala` | `core/src/test/scala/org/apache/spark/shuffle/streaming/StreamingShuffleBenchmark.scala` | &mdash; |
